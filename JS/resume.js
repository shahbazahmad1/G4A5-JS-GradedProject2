...
function updateAfterSearch() {
  ...
  if (searchResults.length === 0) {
    listDiv.innerHTML = `
			<div class="search-result" style="border: 1px solid black; border-radius: 10px; padding: 20px;width:360px;height:195px;">
				<img width='80' height='80' src='Images/download.png' alt='No results found'/>
